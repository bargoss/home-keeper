...
public struct OnGoInGameRequest : IRpcCommand
{
}
...
public partial struct OnGoInGameClientSystem : ISystem
{
    [BurstCompile]
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach (var (id, entity) in SystemAPI.Query<RefRO<NetworkId>>().WithEntityAccess().WithNone<NetworkStreamInGame>())
        {
            ...
            commandBuffer.AddComponent<OnGoInGameRequest>(req);
...
public partial struct GoInGameServerSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach (var (reqSrc, reqEntity) in SystemAPI.Query<RefRO<ReceiveRpcCommandRequest>>().WithAll<OnGoInGameRequest>().WithEntityAccess())
        {
